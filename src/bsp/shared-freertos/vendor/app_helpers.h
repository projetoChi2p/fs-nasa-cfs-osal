...
#define HLP_RESET_TYPE_POWERON  1
#define HLP_RESET_TYPE_WATCHDOG 2
#define HLP_RESET_TYPE_SOFTWARE 3
#define HLP_RESET_TYPE_EXTERNAL 4
#define HLP_RESET_TYPE_DEBUG    5
