...
*/
#define LIBERO_SETTING_IOMUX0_CR    0x00001084UL
...
(Equivalent to Tristate),0xB implies GPIO ,0xC implies Fabric-test,0xD implies
Logic 0,0xE implies Logic 1, 0xF implies Tristate */
#define LIBERO_SETTING_IOMUX3_CR    0xF55FF55FUL
...
(Equivalent to Tristate),0xB implies GPIO ,0xC implies Fabric-test,0xD implies
Logic 0,0xE implies Logic 1, 0xF implies Tristate */
#define LIBERO_SETTING_IOMUX4_CR    0xFFFFFFBFUL
    /* PAD22                             [0:4]   RW value= 0xF */
    /* PAD23                             [4:4]   RW value= 0xB */
...
#define LIBERO_SETTING_MSSIO_BANK4_IO_CFG_0_1_CR    0x09300928UL
...
#define LIBERO_SETTING_MSSIO_CONFIGURATION_OPTIONS    0x00000006UL
